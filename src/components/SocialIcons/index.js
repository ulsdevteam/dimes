...
const SocialIcons = () => (
  <div className="rac-social-icons">
    <a href="https://twitter.com/rockarch_org">
    ...
    <a href="https://www.facebook.com/RockefellerArchiveCenter">
      <span className="social__icon">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
    ...
    <a href="https://www.instagram.com/rockefellerarchivecenter">
      <span className="social__icon">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
    ...
    <a href="https://www.youtube.com/channel/UCks9ctz4OF9tMNOTrRkWIZg">
      <span className="social__icon">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
    ...
    <a href="https://www.flickr.com/photos/147074352@N05/">
      <span className="social__icon">
        <svg width="18px" height="24px" viewBox="0 0 18 8" version="1.1" xmlns="http://www.w3.org/2000/svg">
